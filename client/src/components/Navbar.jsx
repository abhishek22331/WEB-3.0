    ...
    return (
        <nav className="w-full flex md:justify-center justify-between items-center p-4">
            ...
            <div className="flex relative">
                {toggleMenu
                    ? <AiOutlineClose fontSize={28} className="text-white md:hiden cursor-pointer" onClick={() => setToggleMenu(false)} />
                    : <HiMenuAlt4 fontSize={28} className="text-white md:hiden cursor-pointer" onClick={() => setToggleMenu(true)} />
                }
                {toggleMenu &&(
